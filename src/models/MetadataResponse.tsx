class MetadataResponse {
    ...
    public readonly team1Adaptability: number;
    public readonly team1TankAdaptability: number;
    public readonly team1DpsAdaptability: number;
    public readonly team1SupportAdaptability: number;
    public readonly team2Adaptability: number;
    public readonly team2TankAdaptability: number;
    public readonly team2DpsAdaptability: number;
    public readonly team2SupportAdaptability: number;
    ...
    constructor(balanceScore: number, balanceTime: number, team1TotalSr: number, team1AverageSr: number, team1TotalSrDistribution: number, team1TotalAverageSr: number, team2TotalSr: number, team2AverageSr: number, team2TotalSrDistribution: number, team2TotalAverageSr: number, team1Adaptability: number, team1TankAdaptability: number, team1DpsAdaptability: number, team1SupportAdaptability: number, team2Adaptability: number, team2TankAdaptability: number, team2DpsAdaptability: number, team2SupportAdaptability: number, team1PositionPreferenceCount: number, team2PositionPreferenceCount: number, totalSRDifference: number) {
        ...
        this.team1Adaptability = team1Adaptability;
        this.team1TankAdaptability = team1TankAdaptability;
        this.team1DpsAdaptability = team1DpsAdaptability;
        this.team1SupportAdaptability = team1SupportAdaptability;
        this.team2Adaptability = team2Adaptability;
        this.team2TankAdaptability = team2TankAdaptability;
        this.team2DpsAdaptability = team2DpsAdaptability;
        this.team2SupportAdaptability = team2SupportAdaptability;
